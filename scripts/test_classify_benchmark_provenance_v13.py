#!/usr/bin/env python3
"""Regression tests for Method v1.3 provenance classification."""
...
POLICY_PATH = ROOT / "results/benchmark/v1.3-protocol/provenance-policy.json"
...
class ProvenanceTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.unit = {
            ...
            "content_sha256": "2" * 64,
            "content_schema": "c5k4-registry-identity-counts-1.3",
            "mixed": False,
            "malformed": False,
        }
        self.exemption = {
