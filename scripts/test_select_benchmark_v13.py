#!/usr/bin/env python3
"""Regression and exact-vector tests for the Method v1.3 C1 selector."""
...
try:
    ...
    from scripts import select_benchmark_v13 as selector
...
def fixtures(extra: int = 1):
    artifacts = {
        key: encoded({"schema_version": f"fixture-{key}-1.3", "payload": key})
...
class SelectionV13Tests(unittest.TestCase):
    def test_exact_frozen_vector_and_complete_evidence(self) -> None:
        ...
        self.assertEqual(
            ...
            [
                "cluster-002", "cluster-004", "cluster-003",
                "cluster-007", "cluster-005", "cluster-008",
                "cluster-011", "cluster-010",
                "cluster-014", "cluster-013",
        ...
        self.assertEqual(
            ...
            "9c69d52e1f59b80d48be28097377d13806f0041f7c2f0251babdbe419cf87830",
        )
