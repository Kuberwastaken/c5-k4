#!/usr/bin/env python3
"""Tests for deterministic Method v1.4 P0 assembly and attestation."""
...
SCRIPT = Path(__file__).with_name("build_benchmark_v14_p0.py")
SPEC = importlib.util.spec_from_file_location("benchmark_v14_p0", SCRIPT)
...
class P0Tests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.temp = tempfile.TemporaryDirectory(prefix="v14-p0-test-", dir=parent)
        ...
        prototype_dir = self.root / "v1.4-prototype"
        prototype_dir.mkdir()
