#!/usr/bin/env python3
"""Assemble and validate non-circular Method v1.3 P0A/P0T artifacts."""
...
SCHEMA = ROOT / "schemas/benchmark-v1.3-p0.schema.json"
SCHEMA_VERSION = "c5k4-method-v1.3-p0-1.0"
CONFIG_VERSION = "c5k4-method-v1.3-p0-components-1.0"
REQUIRED_COMPONENTS = (
    "protocol_document",
...
JSON_CONTRACTS = {
    ...
    "grouping_rule": (
        "c5k4-question-cluster-grouping-rule-1.3",
    ...
    "target_data_audit_rule": (
        "c5k4-target-data-audit-rule-1.3",
...
def validate_audit_receipt(receipt_ref: dict[str, str], components: dict[str, Any]) -> None:
    ...
    if receipt["schema_version"] != "c5k4-method-v1.3-target-data-audit-receipt-1.0":
