#!/usr/bin/env python3
"""Regression and exact-vector tests for the Method v1.4 C1 selector."""
...
try:
    ...
    from scripts import select_benchmark_v14 as selector
...
def fixtures(extra: int = 1):
    artifacts = {
        key: encoded({"schema_version": f"fixture-{key}-1.4", "payload": key})
...
class SelectionV14Tests(unittest.TestCase):
    def test_exact_frozen_vector_and_complete_evidence(self) -> None:
        ...
        self.assertEqual(
            ...
            [
                "cluster-003", "cluster-001", "cluster-004",
                "cluster-008", "cluster-006", "cluster-007",
                "cluster-011", "cluster-009",
                "cluster-013", "cluster-012",
                "cluster-015", "cluster-017",
            ],
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "fbdadb5c5ca80cea9ac50d9069851b74a815190abe971c56505089186e40986e",
        )
