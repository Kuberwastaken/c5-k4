#!/usr/bin/env python3
"""Regression fixtures for the Method v1.2 fail-closed linter."""
...
SCRIPT = Path(__file__).with_name("lint_benchmark_v12.py")
SPEC = importlib.util.spec_from_file_location("benchmark_v12_linter", SCRIPT)
...
class BenchmarkV12LintTests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def manifest(self, *, feasible: bool, complete: bool = False) -> dict:
        ...
        s0 = {
            "schema_version": "c5k4-source-snapshot-S0-1.2", "snapshot_id": "S0",
        ...
        cert = {
            "schema_version": "c5k4-quota-feasibility-1.2", "phase": "PRE_C0_FEASIBILITY",
        ...
        manifest = {
            "$schema": "schemas/benchmark-v1.2.schema.json", "schema_version": LINTER.SCHEMA_VERSION, "benchmark_id": "v12-fixture", "phase": phase,
