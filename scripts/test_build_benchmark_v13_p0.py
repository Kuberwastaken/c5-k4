#!/usr/bin/env python3
"""Tests for deterministic Method v1.3 P0 assembly and attestation."""
...
SCRIPT = Path(__file__).with_name("build_benchmark_v13_p0.py")
SPEC = importlib.util.spec_from_file_location("benchmark_v13_p0", SCRIPT)
...
class P0Tests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.temp = tempfile.TemporaryDirectory(prefix="v13-p0-test-", dir=parent)
        ...
        prototype_dir = self.root / "v1.3-prototype"
        prototype_dir.mkdir()
