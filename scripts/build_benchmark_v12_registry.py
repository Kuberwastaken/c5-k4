#!/usr/bin/env python3
"""Perform the sole production Method v1.2 registry build.
...
import build_benchmark_contamination_v12 as contamination
import build_benchmark_v12_p0 as p0
import build_benchmark_v12_pool as syntax
import build_benchmark_v12_source_snapshot as source_snapshot
import select_benchmark_v12 as selector


ROOT = Path(__file__).parents[1].resolve()
INPUT_SCHEMA = ROOT / "schemas/benchmark-registry-input-v1.2.schema.json"
OUTPUT_SCHEMA = ROOT / "schemas/benchmark-registry-output-v1.2.schema.json"
INPUT_SCHEMA_VERSION = "c5k4-registry-build-input-1.2"
OUTPUT_SCHEMA_VERSION = "c5k4-registry-build-output-1.2"
PREFLIGHT_SCHEMA_VERSION = "c5k4-registry-preflight-input-1.2"
RECEIPT_SCHEMA_VERSION = "c5k4-resolver-receipt-1.2"
...
OUTPUT_SCHEMAS = {
    "open_inventory": "c5k4-open-inventory-1.2",
    "question_cluster_pool": "c5k4-question-cluster-pool-1.2",
    "provenance_inventory": "c5k4-provenance-inventory-1.2",
    "contamination_inventory": "c5k4-contamination-inventory-1.2",
    "eligible_pool": "c5k4-eligible-cluster-pool-1.2",
    "quota_feasibility": "c5k4-quota-feasibility-1.2",
}
...
SELF_DIGEST_BY_SCHEMA = {
    "c5k4-source-snapshot-S0-1.2": "snapshot_sha256",
    "c5k4-semantic-sources-config-1.2": "sources_config_sha256",
    "c5k4-contamination-inventory-1.2": "inventory_sha256",
    "c5k4-eligible-cluster-pool-1.2": "eligible_pool_sha256",
    "c5k4-quota-feasibility-1.2": "certificate_sha256",
    "c5k4-registry-exemption-rule-1.2": "inventory_sha256",
...
def validate_protocol_bindings(
    ...
    producer_files = {
        ...
        "invocation_contract_sha256": ROOT / "results/benchmark/v1.2-protocol/registry-build-invocation.json",
...
def validate_exemption_ledger(
    ...
    if ledger.get("schema_version") != "c5k4-registry-exemption-rule-1.2":
