#!/usr/bin/env python3
"""Replay Method v1.3 identity exposure without reading target semantics.
...
import classify_benchmark_provenance_v13 as provenance
import build_benchmark_v13_source_snapshot as source_snapshot


SCHEMA = "c5k4-contamination-inventory-1.3-prototype"
CONFIG_SCHEMA = "c5k4-contamination-sources-1.3-prototype"
OVERLAY_SCHEMA = "c5k4-eligible-cluster-pool-1.3-prototype"
FEASIBILITY_SCHEMA = "c5k4-quota-feasibility-1.3-prototype"
...
def build(pool: dict[str, Any], config: dict[str, Any], exemptions: dict[str, Any]) -> tuple[dict[str, Any], dict[str, Any], dict[str, Any]]:
    ...
    policy_path = Path(__file__).resolve().parents[1] / "results/benchmark/v1.3-protocol/provenance-policy.json"
