#!/usr/bin/env python3
"""Tests for provenance-bound Method v1.2 registry exemptions."""
...
import build_registry_exemptions_v12 as exemptions
...
class Fixture:
    def __init__(self, root: Path) -> None:
        ...
        self.artifact = (
            json.dumps(
                {"schema_version": "c5k4-open-inventory-1.2", "declarations": []},
                sort_keys=True,
                indent=2,
            )
            + "\n"
            ...
            "outputs": [
                {
                    ...
                    "schema_version": "c5k4-open-inventory-1.2",
...
class RegistryExemptionTests(unittest.TestCase):
    ...
    def test_mixed_prose_cannot_be_registered_as_machine_artifact(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            fixture = Fixture(Path(directory))
            prose = b'{"schema_version":"c5k4-open-inventory-1.2"}\nDiscussion follows.'
