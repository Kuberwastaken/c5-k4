#!/usr/bin/env python3
"""Regression tests for the syntax-only Method v1.4 prototype builder."""
...
import build_benchmark_v14_pool as pool  # noqa: E402


CLASSIFIER = (
    ROOT / "results" / "benchmark" / "v1.4-prototype" / "five-strata-classifier.json"
)
AUTHORITATIVE_CLASSIFIER = (
    ROOT / "results" / "benchmark" / "v1.4-protocol" / "five-strata-classifier.json"
)


class PoolV14Tests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_authoritative_classifier_has_executable_rules_matching_prototype(self) -> None:
        ...
        self.assertEqual(authoritative["schema_version"], "c5k4-five-strata-classifier-1.4")
