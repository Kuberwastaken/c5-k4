#!/usr/bin/env python3
"""Focused tests for the one-shot Method v1.3 production registry builder."""
...
import build_benchmark_v13_registry as registry  # noqa: E402


class RegistryBuilderTests(unittest.TestCase):
    def test_authoritative_exemptions_are_exact_two_historical_units(self) -> None:
        ledger = json.loads(
            (ROOT / "results/benchmark/v1.3-protocol/registry-exemption-rule.json").read_text(
                encoding="utf-8"
            )
        )
        policy = json.loads(
            (ROOT / "results/benchmark/v1.3-protocol/provenance-policy.json").read_text(
                encoding="utf-8"
            )
        )
    ...
    def request_fixture(self) -> dict:
        ...
        return {
            ...
            "authority": "PRODUCTION_AFTER_P0T_S0", "protocol_version": "1.3",
    ...
    def test_row_replay_accepts_exact_fail_and_rejects_false_fail(self) -> None:
        ...
        feasibility = {
            "schema_version": "c5k4-quota-feasibility-1.3", "status": "FAIL",
            "strata": strata,
        }
    ...
    def test_s0_canonical_digest_omits_snapshot_not_input_binding(self) -> None:
        value = {
            "schema_version": "c5k4-source-snapshot-S0-1.3",
    ...
    def test_exemption_ledger_is_unit_exact_and_rule_bound(self) -> None:
        policy = {
            ...
            "bounded_content_schemas": ["c5k4-open-inventory-1.3"],
        }
        row = {
            ...
            "content_schema": "c5k4-open-inventory-1.3",
        ...
        ledger = {
            "schema_version": "c5k4-registry-exemption-rule-1.3",
