...
class AggregateCertificateTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        frozen = {
            "arm_execution": {key: dict(ref) for key in (
                ...
                "linux_isolation_acceptance", "linux_isolation_acceptance_test",
                "production_adapter", "production_adapter_test", "production_isolation_attestation_schema",
                "production_triplet_acceptance_schema",
            )},
            ...
            "controlled_harness": {key: dict(ref) for key in (
                ...
                "activation_schema", "unit_schema", "unit_generator", "unit_generator_test",
                "deployment_contract", "deployment_contract_schema", "deployment_verifier", "deployment_test",
                "systemd_unit", "sysusers_asset", "tmpfiles_asset", "network_policy", "destructive_gap_plan",
                "activation_continuity_verifier", "activation_continuity_test",
                "https_daemon_contract", "https_daemon_contract_schema", "https_daemon", "https_daemon_test",
            )},
            "grouping": {"policy": dict(ref)},
            ...
            "checkpoint_runner": {key: dict(ref) for key in (
                ...
                "role_resolver", "role_resolver_test", "role_resolution_schema", "role_resolution_readiness_schema",
            ...
            "immutable_store": {key: dict(ref) for key in (
                ...
                "private_artifact_locator_schema", "config_schema", "readiness_schema", "infrastructure_plan",
                "infrastructure_cloudformation", "infrastructure_verifier", "infrastructure_test",
                "live_acceptance_schema", "live_acceptance_verifier", "live_acceptance_test",
            )},
            "participant_scope": {key: dict(ref) for key in (
                "ledger", "ledger_schema", "noninterference_receipt", "noninterference_receipt_schema",
                "operational_noninterference_receipt_schema", "verifier", "test",
    ...
    def test_selector_manifest_resolves_only_authenticated_p1_roles(self) -> None:
        ...
        native_paths = {
            ...
            "linux_isolation_acceptance": "scripts/method_v15_linux_isolation_acceptance.py",
            "linux_isolation_acceptance_contract_test": "scripts/test_method_v15_linux_isolation_acceptance.py",
            "triplet_production_adapter": "scripts/method_v15_triplet_production_adapter.py",
            "triplet_production_adapter_contract_test": "scripts/test_method_v15_triplet_production_adapter.py",
            "production_isolation_attestation_schema": "schemas/benchmark-production-isolation-attestation-v1.5.schema.json",
            "production_triplet_acceptance_certificate_schema": "schemas/benchmark-production-triplet-acceptance-certificate-v1.5.schema.json",
            "controlled_harness_service_contract": "results/benchmark/v1.5-protocol/controlled-harness-service-contract.json",
            "controlled_harness_service_contract_schema": "schemas/benchmark-controlled-harness-service-contract-v1.5.schema.json",
            "target_blind_checkpoint_request_schema": "schemas/benchmark-target-blind-checkpoint-request-v1.5.schema.json",
            "controlled_harness_response_schema": "schemas/benchmark-controlled-harness-response-v1.5.schema.json",
            "controlled_harness_service": "scripts/method_v15_controlled_harness_service.py",
            "controlled_harness_service_contract_test": "scripts/test_method_v15_controlled_harness_service.py",
            "operational_controlled_harness_activation_schema": "schemas/benchmark-operational-controlled-harness-activation-v1.5.schema.json",
            "operational_controlled_harness_unit_schema": "schemas/benchmark-operational-controlled-harness-unit-v1.5.schema.json",
            "operational_harness_unit_generator": "scripts/generate_benchmark_v15_operational_harness_unit.py",
            "operational_harness_unit_generator_contract_test": "scripts/test_generate_benchmark_v15_operational_harness_unit.py",
            "controlled_harness_deployment_contract": "results/benchmark/v1.5-protocol/controlled-harness-deployment-contract.json",
            "controlled_harness_deployment_contract_schema": "schemas/benchmark-controlled-harness-deployment-contract-v1.5.schema.json",
            "controlled_harness_deployment_verifier": "scripts/verify_benchmark_v15_harness_deployment.py",
            "controlled_harness_deployment_contract_test": "scripts/test_verify_benchmark_v15_harness_deployment.py",
            "controlled_harness_systemd_unit": "deployment/benchmark-v15-controlled-harness/c5k4-benchmark-v15.service",
            "controlled_harness_sysusers_asset": "deployment/benchmark-v15-controlled-harness/c5k4-benchmark-v15.sysusers",
            "controlled_harness_tmpfiles_asset": "deployment/benchmark-v15-controlled-harness/c5k4-benchmark-v15.tmpfiles",
            "controlled_harness_network_policy": "deployment/benchmark-v15-controlled-harness/network-policy.json",
            "controlled_harness_destructive_gap_plan": "deployment/benchmark-v15-controlled-harness/destructive-gap-plan.json",
            "controlled_harness_activation_continuity_verifier": "scripts/verify_benchmark_v15_activation_continuity.py",
            "controlled_harness_activation_continuity_contract_test": "scripts/test_verify_benchmark_v15_activation_continuity.py",
            "controlled_harness_https_daemon_contract": "results/benchmark/v1.5-protocol/controlled-harness-https-daemon-contract.json",
            "controlled_harness_https_daemon_contract_schema": "schemas/benchmark-controlled-harness-https-daemon-contract-v1.5.schema.json",
            "controlled_harness_https_daemon": "scripts/method_v15_controlled_harness_https_daemon.py",
            "controlled_harness_https_daemon_contract_test": "scripts/test_method_v15_controlled_harness_https_daemon.py",
            ...
            "p1_role_resolver": "scripts/resolve_benchmark_v15_p1_roles.py",
            "p1_role_resolver_contract_test": "scripts/test_resolve_benchmark_v15_p1_roles.py",
            "p1_role_resolution_schema": "schemas/benchmark-p1-role-resolution-v1.5.schema.json",
            "p1_role_resolution_readiness_schema": "schemas/benchmark-p1-role-resolution-readiness-v1.5.schema.json",
            "participant_ledger": "results/benchmark/v1.5-protocol/participant-ledger.json",
            "participant_ledger_schema": "schemas/benchmark-participant-ledger-v1.5.schema.json",
            "noninterference_receipt": "results/benchmark/v1.5-protocol/noninterference-receipt.json",
            "noninterference_receipt_schema": "schemas/benchmark-noninterference-receipt-v1.5.schema.json",
            "operational_noninterference_receipt_schema": "schemas/benchmark-operational-noninterference-receipt-v1.5.schema.json",
            "noninterference_key_commitment": "results/benchmark/v1.5-protocol/noninterference-key-commitment.json",
            "noninterference_key_commitment_schema": "schemas/benchmark-noninterference-key-commitment-v1.5.schema.json",
            "operational_noninterference_key_commitment_schema": "schemas/benchmark-operational-noninterference-key-commitment-v1.5.schema.json",
            "participant_noninterference_verifier": "scripts/verify_benchmark_v15_participant_noninterference.py",
            "participant_noninterference_contract_test": "scripts/test_verify_benchmark_v15_participant_noninterference.py",
            ...
            "immutable_infrastructure_plan": "infra/benchmark-v1.5/immutable-store/plan.json",
            "immutable_infrastructure_cloudformation": "infra/benchmark-v1.5/immutable-store/cloudformation.json",
            "immutable_infrastructure_verifier": "scripts/verify_benchmark_v15_immutable_infrastructure.py",
            "immutable_infrastructure_contract_test": "scripts/test_verify_benchmark_v15_immutable_infrastructure.py",
            "immutable_live_acceptance_evidence_schema": "infra/benchmark-v1.5/immutable-store/live-acceptance-evidence.schema.json",
            "immutable_live_acceptance_verifier": "scripts/verify_benchmark_v15_immutable_live_acceptance.py",
            "immutable_live_acceptance_contract_test": "scripts/test_verify_benchmark_v15_immutable_live_acceptance.py",
        }
        inherited_paths = {
