#!/usr/bin/env python3
"""Tests for isolated Method v1.2 C0A/C0T assembly."""
...
SCRIPT = Path(__file__).with_name("build_benchmark_v12_c0.py")
SPEC = importlib.util.spec_from_file_location("benchmark_v12_c0_tested", SCRIPT)
...
class C0Tests(unittest.TestCase):
    def setUp(self):
        ...
        self.temp = tempfile.TemporaryDirectory(prefix="v12-c0-test-", dir=parent)
        ...
        p0a = {
            ...
            "authority": "AUTHORITATIVE_P0", "protocol_version": "1.2",
        ...
        install("p0a", p0a)
        p0t = {
            "schema_version": C0.P0.SCHEMA_VERSION, "artifact_kind": "P0T", "protocol_version": "1.2",
