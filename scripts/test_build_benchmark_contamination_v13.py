#!/usr/bin/env python3
"""Regression tests for the provenance-aware Method v1.3 replay."""
...
import build_benchmark_contamination_v13 as replay
...
def fixture_pool(clusters: list[dict]) -> dict:
    return {
        "schema_version": "c5k4-question-cluster-pool-1.3-prototype",
