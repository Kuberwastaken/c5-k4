#!/usr/bin/env python3
"""Discover and freeze Method v1.3 semantic-source boundaries without semantics.
...
POLICY_SCHEMA = "c5k4-source-path-purpose-policy-1.3"
CONFIG_SCHEMA = "c5k4-semantic-sources-config-1.3"
PROTOTYPE_CONFIG_SCHEMA = CONFIG_SCHEMA + "-prototype"
P0_SCHEMA = "c5k4-method-v1.3-p0-1.0"
SNAPSHOT_SCHEMA = "c5k4-source-snapshot-S0-1.3"
...
def discovery_contract_bytes(
    ...
    return canonical_json(
        {
            "tool": "build_benchmark_v13_source_snapshot.py/discover",
