#!/usr/bin/env python3
"""Focused tests for the Method v1.3 isolated equal-budget runner."""
...
SCRIPT = Path(__file__).with_name("run_benchmark_v13_job.py")
SPEC = importlib.util.spec_from_file_location("benchmark_v13_runner", SCRIPT)
...
class BenchmarkV13RunnerTests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def contract(self, mode: str, arm: str | None, count: int, cpu_budget: int) -> dict:
        ...
        return {
            "$schema": "schemas/benchmark-run-contract-v1.3.schema.json",
            "schema_version": "c5k4-benchmark-run-contract-1.3",
            "benchmark_version": "c5k4-benchmark-1.3",
    ...
    def test_process_environment_is_a_secret_free_fixed_allowlist(self) -> None:
        ...
        self.assertEqual(environment["C5K4_BENCHMARK_VERSION"], "1.3")
