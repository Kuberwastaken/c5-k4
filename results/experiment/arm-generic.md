...
**Written incrementally; last update 2026-08-16T11:41:30Z.**
...
| FP-002 | `alpha >= dist_even_max - chi` | **CROSSED** | ``L`cAwH@CxsVySP`` | 13 | 5 | 6 | FAM | 0.04 | PASS | PASS |
| FP-003 | `alpha >= lambda_max - cutv` | **BRACKET** | — | — | — | — | — | 240.01 | n/a (no candidate) | n/a (no candidate) |
| FP-004 | `A >= floor((disp_min)/2) + dist_avg` | **BRACKET** | — | — | — | — | — | 240.01 | n/a (no candidate) | n/a (no candidate) |
| FP-005 | `A >= floor((n)/(gamma_t))` | **BRACKET** | — | — | — | — | — | 240.0 | n/a (no candidate) | n/a (no candidate) |
| FP-006 | `chi >= ceil((omega - chi_regular)/2) + 1` | **BRACKET** | — | — | — | — | — | 240.41 | n/a (no candidate) | n/a (no candidate) |
| FP-007 | `diam <= disp_max + gamma_2` | **CROSSED** | `HAgcACO` | 9 | 8 | 7 | FAM | 8.46 | PASS | PASS |
| FP-008 | `diam >= floor((A)/(ceil(lambda_1)))` | **CROSSED** | `L???????????~~` | 13 | 2 | 3 | FAM | 0.65 | PASS | PASS |
| FP-009 | `gamma <= floor((lambda_avg)/2) + res` | **CROSSED** | `N?I@?CAOCc?C?C?Gg??` | 15 | 7 | 6 | FAM | 0.19 | PASS | PASS |
| FP-010 | `gamma <= gamma_2 - chi_C4free` | **BRACKET** | — | — | — | — | — | 240.01 | n/a (no candidate) | n/a (no candidate) |
| FP-011 | `gamma >= ceil((Tdist_min)/(m))` | **BRACKET** | — | — | — | — | — | 240.01 | n/a (no candidate) | n/a (no candidate) |
| FP-012 | `gamma_2 <= dist_even_max - chi_regular + 2` | **CROSSED** | `IkQ?K@?G?` | 10 | 8 | 7 | FAM | 0.2 | PASS | PASS |
| FP-013 | `gamma_2 >= ceil((Delta)/(Sigma_2))` | **BRACKET** | — | — | — | — | — | 240.05 | n/a (no candidate) | n/a (no candidate) |
| FP-014 | `gamma_2 >= floor((dist_even_min + disp_min)/2)` | **CROSSED** | `Q??????k|{Y[ao~w^gD~?[wBm??` | 18 | 5 | 6 | FAM | 0.42 | PASS | PASS |
| FP-015 | `gamma_i <= diam + mu - 1` | **CROSSED** | `UqP?GP?GC?G?C?C?C??G?O?A??A???O?A???G???` | 22 | 11 | 10 | FAM | 0.22 | PASS | PASS |
| FP-016 | `gamma_i <= floor((alpha)/2) + gamma` | **CROSSED** | `I_A_L?SVO` | 10 | 5 | 4 | ANNEAL | 103.23 | PASS | PASS |
| FP-017 | `gamma_t >= floor((cutv + chi_tree)/2) + 1` | **BRACKET** | — | — | — | — | — | 240.06 | n/a (no candidate) | n/a (no candidate) |
| FP-018 | `gamma_t >= floor((gamma)/(disp_min))` | **BRACKET** | — | — | — | — | — | 240.1 | n/a (no candidate) | n/a (no candidate) |
| FP-019 | `kappa <= floor((t)/2) + floor(lambda_1)` | **BRACKET** | — | — | — | — | — | 240.01 | n/a (no candidate) | n/a (no candidate) |
| FP-020 | `kappa >= floor((disp_avg - ecc_avg)/2) + 1` | **CROSSED** | `OwbWmk_vomazb?fvaRMYc` | 16 | 1 | 2 | FAM | 0.34 | PASS | PASS |
| FP-021 | `kappa >= floor((lambda_avg - disp_max)/2) + 1` | **CROSSED** | `M?~vfbokF_]?G?w??` | 14 | 1 | 2 | FAM | 30.15 | PASS | PASS |
| FP-022 | `lambda_max >= floor((dd - f_1)/2)` | **CROSSED** | `LZ~Rzv~}v^^~^~` | 13 | 2 | 3 | FAM | 0.01 | PASS | PASS |
| FP-023 | `lambda_max >= floor((gamma_2 - chi)/2) + 1` | **CROSSED** | `K_Q@@OO?gC@?` | 12 | 3 | 4 | FAM | 0.29 | PASS | PASS |
| FP-024 | `mu <= ceil((n - chi_tree)/2)` | **BRACKET** | — | — | — | — | — | 240.05 | n/a (no candidate) | n/a (no candidate) |
| FP-025 | `mu >= floor((delta + lambda_min)/2)` | **BRACKET** | — | — | — | — | — | 240.38 | n/a (no candidate) | n/a (no candidate) |
| FP-026 | `rad >= floor((disp_max)/(floor(lambda_1)))` | **BRACKET** | — | — | — | — | — | 240.6 | n/a (no candidate) | n/a (no candidate) |
| FP-027 | `rad >= floor((ecc_avg)/2) + chi_bipartite` | **BRACKET** | — | — | — | — | — | 240.0 | n/a (no candidate) | n/a (no candidate) |
...
|---|---|---|---|---|---|---|---|---|
| FP-001 | BRACKET | 0 | `TsaCCA?_C?O?_?_?O?C??_?A??C??C??A???` | random bipartite p=0.70 n=21 | 508568 | 40 | 260 | 240.0 |
| FP-003 | BRACKET | 0 | ``_k`[iXolrL]DoLip]{{juQ}T]^{XsC^TvsAwd~Qrfa_ro{kTSwLjKt@IcfjYW||BvN{_Ifx}jtrHt}naDaQg`` | G(n,p) p=0.55 n=32 | 191423 | 40 | 100 | 240.01 |
| FP-004 | BRACKET | 7/5 | `IrS?OGD@w` | anneal n=10 unit=57 | 736856 | 40 | 440 | 240.01 |
| FP-005 | BRACKET | 0 | `g~z~~z}~~|z~~~~~~|~~z~~}~~~zn~~^~~zr~}~}~^~~n~~~|^~~~~~}~~~|~~Zvnry~~~zz~~~~vn~~~~|~n^~~~~n~n~v~~~l~~|Zf~~z~nYn~~~n~zn^~~|~~~n~~~~~` | G(n,p) p=0.92 n=40 | 407178 | 40 | 220 | 240.0 |
| FP-006 | BRACKET | 0 | `M??????PGE?CEWiO?` | random bipartite p=0.20 n=14 | 162321 | 40 | 80 | 240.41 |
| FP-010 | BRACKET | 0 | `H_?__Qw` | random tree n=9 | 74967 | 28 | 40 | 240.01 |
| FP-011 | BRACKET | 0 | `UXl|p~~n|vv~^^zH~~||zn~||~xuxqIDG~}nMvIg` | random geometric r=0.60 n=22 | 306798 | 40 | 160 | 240.01 |
| FP-013 | BRACKET | 0 | `J???????F~_` | random bipartite p=0.70 n=11 | 89459 | 28 | 40 | 240.05 |
| FP-017 | BRACKET | 0 | `Ia?PDCGIo` | random geometric r=0.25 n=10 | 312281 | 40 | 160 | 240.06 |
| FP-018 | BRACKET | 0 | ``f}X`HCoIAOCGa?E?B??`?A?Go???a?AA?AO?OG??__????aOC??E???A??G??AG?A??C?__??B????@???G???C?@A??A??_???CGA????_?G?????P???C????A?`` | preferential attachment m=2 n=39 | 158356 | 40 | 80 | 240.1 |
| FP-019 | BRACKET | 0 | `KC_??WcOa_CO` | random 2-regular n=12 | 32076 | 36 | 20 | 240.01 |
| FP-024 | BRACKET | 0 | ``_?_gE?I?WG@wAkkGW?O`kA?AAW?CAGOq???CDg??SCGpACc?ggDOaQ_A?g@C?@BIt_GS?EO`O?AoPCOSKGSG`` | random 7-regular n=32 | 78927 | 40 | 40 | 240.05 |
| FP-025 | BRACKET | 0 | `gsaCCA?_C?O?_?_?O?C??_?A??C??C??A???_??C???O???_???_???O???C????_???A????C????C????A?????_????C?????O?????_?????_?????O?????C??????` | random bipartite p=0.20 n=40 | 70298 | 40 | 40 | 240.38 |
| FP-026 | BRACKET | 0 | `JhF~h}VLtK_` | preferential attachment m=5 n=11 | 68999 | 40 | 40 | 240.6 |
| FP-027 | BRACKET | 0 | ``M`?dC@??_C@?G?E??`` | G(n,p) p=0.08 n=14 | 745543 | 40 | 400 | 240.0 |
| FP-028 | BRACKET | 0 | `H~~~~~~` | random 8-regular n=9 | 1066622 | 40 | 620 | 240.0 |
